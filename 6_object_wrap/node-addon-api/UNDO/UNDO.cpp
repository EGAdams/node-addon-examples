...
void Undo::setMode1Undo() {
  _gameState->setPrev3PointFlash(
      _gameState->getPrev2PointFlash());  // prev3PointFlash = prev2PointFlash;
  ...
  _gameState->setPrev3P1Matches(
      _gameState->getPrev2P1Matches());  // prev3P1Matches = prev2P1Matches;
  _gameState->setPrev3P2Matches(
      _gameState->getPrev2P2Matches());  // prev3P2Matches = prev2P2Matches;
  ...
  _gameState->setPrev3TieLEDsOn(
      _gameState->getPrev2TieLEDsOn());  // prev3TieLEDsOn = prev2TieLEDsOn;

  _gameState->setPrev2PointFlash(
      _gameState
          ->getPrev1PointFlash());  //  prev2PointFlash  = prev1PointFlash;
  _gameState->setPrev2P1Points(
      _gameState->getPrev1P1Points());  //  prev2P1Points    = prev1P1Points;
  _gameState->setPrev2P2Points(
      _gameState->getPrev1P2Points());  //  prev2P2Points    = prev1P2Points;
  ...
  _gameState->setPrev2P1Matches(
      _gameState->getPrev1P1Matches());  //  prev2P1Matches   = prev1P1Matches;
  _gameState->setPrev2P2Matches(
      _gameState->getPrev1P2Matches());  //  prev2P2Matches   = prev1P2Matches;
  _gameState->setPrev2Serve(
      _gameState->getPrev1Serve());  //  prev2Serve       = prev1Serve;
  _gameState->setPrev2TieBreak(
      _gameState->getPrev1TieBreak());  //  prev2TieBreak    = prev1TieBreak;
  _gameState->setPrev2SetTieBreak(
      _gameState
          ->getPrev1SetTieBreak());  //  prev2SetTieBreak = prev1SetTieBreak;
  _gameState->setPrev2TieLEDsOn(
      _gameState->getPrev1TieLEDsOn());  //  prev2TieLEDsOn   = prev1TieLEDsOn;

  _gameState->setPrev1PointFlash(
      _gameState->getPrevPointFlash());  // prev1PointFlash = prevPointFlash;
  ...
  _gameState->setPrev1SetTieBreak(
      _gameState->getPrevSetTieBreak());  // prev1SetTieBreak = prevSetTieBreak;
  ...
  _gameState->setPrevP2Games(
      _player2->getGames());                       // prevP2Games     = p2Games;
  _gameState->setPrevP1Sets(_player1->getSets());  // prevP1Sets      = p1Sets;
  _gameState->setPrevP2Sets(_player2->getSets());  // prevP2Sets      = p2Sets;
  ...
  _gameState->setPrevServe(_gameState->getServe());  // prevServe       = serve;
